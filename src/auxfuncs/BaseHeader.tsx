                                ...
                                globalData['user'] ?
                                    <>
                                        <div className="SideBySide ">
                                            <div className="CenterHorizontally btn btn-success">
                                                <Link to="/profile" className="CatLink" onClick={()=>{
                                            ...
                                            <div className="CenterHorizontally btn btn-danger" >
                                                <Link to="/" className="CatLink" onClick={LogoutUser}>
                                                    Log out
                                                </Link>
                                            </div>
                                        </div>
                                    ...
                                    <>
                                        <div className="SideBySide ">
                                            ...
                                            <div className="CenterHorizontally btn btn-warning">
